...
console.log(year1 + 5)
console.log(typeof year1) // hier sind es nummern die addiert werden können

console.log(year2 + 5)
console.log(typeof year2) // hier sind es halt 2 strings die anneinander gehangen werden
